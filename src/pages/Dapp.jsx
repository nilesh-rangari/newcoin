...
export default function Reference() {
    ...
    return(
        ...
        {/* sidebar  */}
            ...
            <div className={`w-72 z-20 bg-[#0f0f0f] py-8 md:relative max-w-[768px]:${isSidebarOpen ? '' : '-translate-x-full'} md:translate-x-0 duration-300 h-screen overflow-auto no-scrollbar fixed -translate-x-full`}>
                ...
                <ul className="pt-6">
                    ...
                    <li className={`flex px-6 font-semibold py-3 cursor-pointer hover:bg-[#282828] hover:text-white  text-sm items-center gap-x-4 
                            mt-2 ${divStyle3}`}
                            onClick={() => setSelectedTab("myTeamSummary")}>
                    ...
                    <li className={`flex px-6 font-semibold py-3 cursor-pointer hover:bg-[#282828] hover:text-white  text-sm items-center gap-x-4 
                            ...
                            onClick={() => setSelectedTab("downlineTeam")}>
                    <svg xmlns="http://www.w3.org/2000/svg"  width="24" height="24" viewBox="0 0 24 24" fill="none">
